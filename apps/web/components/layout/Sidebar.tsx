...
import { Lock, LogOut, PanelLeft, User } from 'lucide-react';
...
const STYLES = {
  ...
  aside:
    'sticky top-0 hidden h-screen w-60 flex-col border-r border-border bg-surface transition-all md:flex',
...
export function Sidebar() {
  ...
  return (
    <aside className={cn(STYLES.aside, collapsed ? 'md:w-16' : 'md:w-60')}>
      {/* 브랜드 */}
      <div
        className={cn(
          STYLES.brand,
